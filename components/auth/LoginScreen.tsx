  ...
  return (
    <div className="min-h-screen bg-cream flex flex-col">
      ...
      <div className="flex-1 px-6 -mt-10">
        <div className="bg-white rounded-3xl shadow-xl p-8 min-h-[300px]">
          {error && (
          ...
          <button 
            ...
            className="w-full bg-white border border-gray-200 text-gray-700 font-bold py-3.5 rounded-xl shadow-sm hover:bg-gray-50 active:scale-[0.98] transition-all flex items-center justify-center gap-3 mb-6"
          >
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
             <div>
                ...
                <div className="relative">
                  ...
                  <input 
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium focus:ring-2 focus:ring-saffron focus:outline-none focus:bg-white transition-all"
                      required
                  />
                </div>
             </div>
             ...
             <button 
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-saffron to-saffron-dark text-white font-bold py-4 rounded-xl shadow-lg shadow-orange-200 active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-50 mt-4"
             >
