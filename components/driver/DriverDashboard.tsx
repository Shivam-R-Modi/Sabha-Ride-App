...
const AssignmentCard: React.FC<AssignmentCardProps> = ({ assignment, onSelect }) => {
    ...
    return (
        <div
            ...
            className="clay-card cursor-pointer relative overflow-hidden group"
        >
            ...
            <div className="flex justify-between items-start mb-4 pl-2">
                <div>
                    <span className={`text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded ${isPickup ? 'bg-orange-100 text-orange-700' : 'bg-blue-100 text-blue-700'
                        }`}>
            ...
            <div className="space-y-4">
                {loading ? (
                    ...
                    <div className="clay-card text-center py-12">
                        ...
                        <p className="text-xs text-muted mt-1">Stay online, assignments will appear automatically.</p>
                    </div>
                )}
            </div>
