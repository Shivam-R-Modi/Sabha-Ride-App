        ...
        <div className="min-h-screen pb-safe">
            ...
            <div className="bg-white shadow-sm border-b border-orange-100 sticky top-0 z-30">
                <div className="p-4 flex items-center justify-between">
                    <button onClick={onBack} className="text-coffee font-medium flex items-center gap-1 hover:bg-black/5 p-2 rounded-xl transition-colors">
                        <X size={20} /> Back
                    </button>
                    ...
                    <button
                        ...
                        className={`p-2 rounded-xl transition-all ${isEditing ? 'clay-button-primary shadow-sm' : 'text-gray-500 hover:bg-gray-100 hover:text-coffee'}`}
                    >
                ...
                <div className="px-4 pb-4 flex justify-between items-end">
                    <div>
                        ...
                        <div className="clay-progress-track w-32 h-2">
                            <div
                    ...
                    {!isEditing && (
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="clay-button-primary flex items-center gap-2 px-4 py-2"
                        >
            ...
            <div className="p-4 space-y-3">
                {passengers.map((p, index) => (
                    <div
                        key={p.id}
                        className={`clay-card p-4 transition-all relative overflow-hidden ${p.stopStatus === 'completed' && !isEditing ? 'opacity-75 scale-[0.99] border-l-4 border-l-green-500' : ''
                            }`}
                    >
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                <div className="flex justify-between items-start">
                                    ...
                                    <span className="text-xs font-semibold text-saffron clay-badge px-2 py-0.5">
                                        {p.eta}
                                    </span>
                                </div>
                                ...
                                <div className="flex items-start gap-1 mt-1 text-gray-500 text-sm" onClick={(e) => e.stopPropagation()}>
                                    ...
                                    {isEditing ? (
                                        <input
                                            ...
                                            className="clay-input w-full p-1 text-xs"
                                        />
                                    ) : (
                                ...
                                {isEditing ? (
                                    ...
                                    <>
                                        <button
                                            ...
                                            className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${p.stopStatus === 'completed'
                ...
                {isEditing && (
                    <div className="space-y-3 pt-2">
                        <button
                            ...
                            className="clay-button-secondary w-full py-4 border-2 border-dashed border-gray-300 bg-transparent shadow-none text-gray-400 font-medium flex items-center justify-center gap-2 hover:border-saffron hover:text-saffron hover:bg-orange-50 transition-colors"
                        >
                            <Plus size={20} />
                            Add Student
                        </button>
            ...
            {/* Add Student Modal */}
            {showAddModal && (
                <div className="clay-modal flex items-end sm:items-center justify-center p-4">
                    <div className="bg-white w-full max-w-sm rounded-3xl overflow-hidden shadow-2xl animate-in slide-in-from-bottom-10 flex flex-col max-h-[80vh]">
