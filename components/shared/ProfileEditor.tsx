            ...
            <div className="p-8 md:p-12 text-center animate-in fade-in duration-500">
                ...
                <div className="mt-8 max-w-sm mx-auto space-y-3">
                    <button
                        ...
                        className="clay-button w-full py-3 text-[rgb(var(--text-on-accent))] bg-gradient-to-r from-saffron-800 to-gold-700 rounded-xl font-bold shadow-lg flex items-center justify-center gap-2"
                    >
                        <Pencil size={18} />
                        Edit Profile
                    </button>
            ...
            <div className="max-w-md mx-auto space-y-5">
                ...
                <div className="flex gap-3 pt-2">
                    ...
                    <button
                        onClick={handleSave}
                        disabled={loading}
                        className="flex-1 py-3 rounded-xl bg-gradient-to-r from-saffron-800 to-gold-700 text-[rgb(var(--text-on-accent))] font-semibold hover:shadow-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                        <Save size={18} />
                        {loading ? 'Saving…' : 'Save'}
                    </button>
