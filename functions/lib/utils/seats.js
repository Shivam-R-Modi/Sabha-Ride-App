...
exports.maxPassengerSeats = maxPassengerSeats;
exports.remaindersFirst = remaindersFirst;
exports.fillBySeats = fillBySeats;
/**
 ...
 */
function maxPassengerSeats(capacities) {
    let best = 0;
 ...
 * blocking the queue.
 */
function fillBySeats(candidates, freeSeats, maxFleetSeats) {
